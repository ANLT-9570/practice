...
@Controller
@Api(tags = "记录-用户流水记录后台")
@RequestMapping("UserMoneyStreamLogAdmin")
public class UserMoneyStreamLogController {
	...
	public slzcResult findAll(@RequestParam(defaultValue = "0")Integer offset,@RequestParam(defaultValue = "15") Integer limit) {
		return userMoneyStreamLogService.selectAll(offset, limit);
	}
	
	//页面跳转
	@GetMapping("/skip")
	public String SkipPage() {
		return "/order/UserMoneyStreamLog";
	}
}
