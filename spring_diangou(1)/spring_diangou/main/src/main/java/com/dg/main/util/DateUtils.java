...
//        System.out.println(random1.nextInt(1,6));
//        IntStream.range(1,100).forEach((i)->{
//            System.out.println(random1.nextInt(5)+1);
//        });
...
//        String responseXml = WXPayUtil.mapToXml(responseMap1);
     //   System.out.println(UserStreamEnum.WEIXIN_DEPOSIT_PLATFORM_MONEY);
      //  System.out.println(UserStreamEnum.WEIXIN_DEPOSIT_PLATFORM_MONEY.getName());
       // CodeGenerator.thirdCode.create(null);
        System.out.println(DateUtils.currentTime());
    }
}
