...
@Controller
@Api(tags = "记录-用户转账记录后台")
@RequestMapping("UserDepositMoneyLogAdmin")
public class UserDepositMoneyLogController {
...
//		return userDepositMoneyLogService.selectAll(offset, limit);
//	}
	
	//页面跳转
	@GetMapping("/skip")
	public String SkipPage() {
		return "/order/UserDepositMoneyLog";
	}
}
