 ...
 */
@RestController
@RequestMapping("/common/wxpay")
public class CommonWXPayController {
    ...
    @GetMapping("/pay")
    public Map<String,String> wxPay(HttpServletRequest request, HttpServletResponse response1) throws Exception {
     ...
     //   data.put("openid", openId);
       ...
       // data.put("time_expire", "20181211110503");
        data.put("appid", WeixinPay.Config.appID);
        data.put("mch_id",WeixinPay.Config.mchID);
        data.put("attach","1");
        data.put("fee_type", "CNY");
        data.put("nonce_str", WXPayUtil.generateNonceStr());
        data.put("notify_url",WeixinPay.Config.notifyUrl);
        String sign = WXPayUtil.generateSignature(data, WeixinPay.Config.key);
        data.put("sign",sign);
...
//
    ...
    public Object refund(String orderNo) throws Exception {
        ...
        // 退款异步通知地址
        reqData.put("notify_url", WeixinPay.Config.notifyUrl);
        reqData.put("refund_fee_type", "CNY");
        reqData.put("op_user_id", WeixinPay.Config.mchID);
...
//        notifyMap.put("return_code", "SUCCESS");
        ...
        Map<String, String> requstInfoMap = ipay.decodeRefundNotify(request);
    ...
    public Object getSignKey() throws Exception {
        WeixinPay ipay=new WeixinPay(wxPayConfig);
        Map<String, String> signKey = ipay.getSignKey();
