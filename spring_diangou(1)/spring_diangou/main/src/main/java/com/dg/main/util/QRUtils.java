...
//        getRequests();
    ...
    public static com.dg.main.util.Result uploadImage(File file) throws Exception{
        ...
        if(StringUtils.isEmpty(string)){
            return  com.dg.main.util.Result.failureResult(ExceptionCode.Failure.SYSTEM_ERROR);
        }
        Gson gson = new Gson();
...
//                });
    ...
    //生成二维码
    public static com.dg.main.util.Result generateQRCode(String text)  {
        ...
        try {
            ...
            com.dg.main.util.Result result = uploadImage(outputFile);
            outputFile.delete();
            return result;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return com.dg.main.util.Result.failureResult(ExceptionCode.Failure.NOT_SPECIFICATION);
    }
    //解析二维码
